<?php
  ...
  $workshop_list = get_sub_field('workshop_list');
...
<section class="speaker <?php echo $speaker_position; ?> <?php echo $speaker_padding; ?>">
  <?php if($workshop_list): ?>
    <div class="speaker_relation">
      <?php foreach ($workshop_list as $post): ?>
        <?php setup_postdata($post); ?>
        <?php $speaker = get_field('related_speaker'); ?>
            ...
            <div class="row">
              ...
              <div class="medium-7 columns end">
                <div class="info_container speaker_preview_info">
                  ...
                  <div class="current-text speaker_description animated_text_auto"><?php the_field('short_description'); ?></div>
