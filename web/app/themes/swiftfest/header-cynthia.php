...
<html class="no-js" <?php language_attributes(); ?>>
  <head>
    ...
    <script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/scripts/circle_custom.js"></script>

  </head>
  <body id="body_transformation" <?php body_class(); ?>>
    ...
    <div class="preloader preloader_siri">
        <div class="loader-inner">
            ...
            <div class="middle-div">
                <div class="inner">
                  <div class="circle_custom_container">
