...
function glitch_scripts() {
  // Load css
  wp_enqueue_style( 'sketchapprome', get_template_directory_uri() . '/dist/styles/app.css', array() );
  ...
  wp_enqueue_script( 'glitch-slick', get_template_directory_uri() . '/assets/scripts/vendor/slick.js', array() );
  wp_enqueue_script( 'sketchapprome', get_template_directory_uri() . '/dist/scripts/app.js', array() );
}
add_action( 'wp_enqueue_scripts', 'glitch_scripts' );
 ...
 */
function glitch_get_post_meta($meta, $key, $counter, $isFromAcf = FALSE, $type = "string", $size = "large") {
  if($isFromAcf) {
